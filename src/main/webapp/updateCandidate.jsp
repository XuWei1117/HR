...
<body>
<div class="container">
    <h3 style="text-align: center;margin-bottom: 30px">修改候选人信息</h3>
    <div class="col-md-6 col-md-offset-3">
        <form class="form-horizontal" id="form" action="candidate/updateCandidate">
    ...
    $(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("#c_departId").val(data.c_departId);
                ...
                departments.each(function () {
                    console.log(data.c_departId == $(this).val());
                    if(data.c_departId == $(this).val()){

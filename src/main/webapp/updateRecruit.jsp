...
<body>
<div class="container">
    <h3 style="text-align: center;margin-bottom: 30px">修改招聘信息</h3>
    <div class="col-md-6 col-md-offset-3">
        <form class="form-horizontal" id="form" action="recruit/updateRecruit">
            ...
            <div class="form-group">
                <label for="r_departId" class="col-sm-2 control-label">所在部门</label>
                <div class="col-sm-10">
                    <select name="r_departId" id="r_departId">
                        <option value="1" class="department">销售部</option>
                        <option value="2" class="department">策划部</option>
                        <option value="3" class="department">财务部</option>
                        <option value="4" class="department">开发部</option>
                        <option value="5" class="department">测试部</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select name="r_empId" id="r_empId">
                        <option value="1" class="person">Anna</option>
                        <option value="6" class="person">Frank</option>
                        <option value="7" class="person">Green</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
    ...
    $(function () {
        ...
        $.get("recruit/selectById",args,function (data) {
            ...
            departments.each(function () {
                console.log(data.r_departId == $(this).val());
                if(data.r_departId == $(this).val()){
                    $(this).attr('selected',true);
                }
            })
            let persons = $(".person");
            persons.each(function () {
                if(data.r_empId == $(this).val()){
                    $(this).attr('selected',true);
                }
            })

...
<body>
<div class="container">
    <h3 style="text-align: center;margin-bottom: 30px">修部门信息</h3>
    <div class="col-md-6 col-md-offset-3">
        <form class="form-horizontal" id="form" action="depart/updateDepart">
...
<script>
    ...
    $(function () {
        ...
        let d_id = args.split("=")[1];
        $.ajax({
            url:"depart/selectById",

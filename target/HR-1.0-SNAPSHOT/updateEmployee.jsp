...
<body>
<div class="container">
    <h3 style="text-align: center;margin-bottom: 30px">修改员工信息</h3>
    <div class="col-md-6 col-md-offset-3">
        <form class="form-horizontal" id="form" action="employee/updateEmployee">
            <div class="form-group">
                <label for="e_id" class="col-sm-2 control-label"></label>
                <div class="col-sm-10">
            ...
            <div class="form-group">
                <label for="e_departId" class="col-sm-2 control-label">所在部门</label>
                <div class="col-sm-10">
                    <select name="e_departId" id="e_departId">
                        ...
                        <option value="6" class="department">运维部</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                departments.each(function () {
                    console.log(data.e_departId == $(this).val());
                    if(data.e_departId == $(this).val()){
